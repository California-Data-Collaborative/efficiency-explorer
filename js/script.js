...
function tsSetup() {
	...
	var markers = [(_ref = {}, _defineProperty(_ref, "" + config.column_names.date, new Date(state.startDate)), _defineProperty(_ref, "label", "SCENARIO START"), _ref), (_ref2 = {}, _defineProperty(_ref2, "" + config.column_names.date, new Date(state.endDate)), _defineProperty(_ref2, "label", "SCENARIO END"), _ref2)],
...
function summarySentence_dm(usageDifference, percentDifference, targetValue, hrName, usage) {
	var place_change = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : false;
